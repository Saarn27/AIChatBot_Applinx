...
public partial class TEU01_ADD : GalLogicWebForm
{
    ...
    protected void page_preFillForm(object sender, EventArgs e)
    {
        ...
        FillComboBox(Warn_WRN, AppCache.GetTableData("T23", new string[] { "F", "GEN", "WRN" }));

        DisableComboBox(new HtmlSelect[] { System_SYS, Warn_WRN, Override_OVR });
    }
