<%@ Page MasterPageFile="~/template.master" Inherits="TFU03_ADD" CodeFile="TFU03_ADD.aspx.cs" Language="C#" %>
    ...
    <div id="gx_screenArea">
        ...
        <div class="main-content" id="mainContent">
            ...
            <div class="wrapper-container">
                <div class="related-fields-area centered-flex w-100" style="margin-bottom: 10px;">
                    <gal-input label-text="Option:" label-size="auto" input-size="xlarge">
                    ...
                    <gal-input label-text="User:" label-size="auto" input-size="xlarge2">
                ...
                <div class="column-form">
                    <div class="spaced-column">
                        ...
                        <div class="related-fields-area">
                            ...
                            <gal-input label-size="medium" input-size="large" label-text="Field description:" no-description>
                                <input id="fieldDescription_TXT" runat="server" />
                            </gal-input>
                            <gal-input label-size="medium" input-size="large" label-text="Field description1:" no-description>
                        ...
                        <div class="related-fields-area centered-flex" style="margin-top: 10px">
                            <gal-input label-size="auto" input-size="small,medium" label-text="User:">
                                <input id="lastUser_A_TFPRDU" runat="server" />
                                <input id="userDescription_A_TFPRDUD" runat="server" />
                            </gal-input>
                            <gal-input label-size="auto" input-size="small2" label-text="Date:" no-description>
                                <input id="lastDate_A_TFTRN" runat="server" galtype="date" dateformat="dd/mm/yy" />
                            </gal-input>
                            <gal-input input-size="xsmall" label-size="small2" label-text="Program value:" no-description>
                                <gx:GXCheckBox ID="ProgValue_B_TFIMC" CheckedValue="Y" UncheckedValue="" runat="server" />
                            </gal-input>
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="related-fields-area" style="width:620px">
