<%@ Page MasterPageFile="~/template.master" Inherits="GWTU05_SFL3" CodeFile="GWTU05_SFL3.aspx.cs" Language="C#" %>
        ...
        <div class="main-area-form" id="mainContent">
            ...
            <div style="width: fit-content">
                <div class="table-container">
                    <table id="GWTU05_SFL3_1" runat="server" class="table gal6-table-striped">
                        <thead>
                            <tr class="grid-header">
                                ...
                                <th>
                                    <gal-input input-size="small" no-description>
                                        <input id="key4Filter_SLK4" runat="server" />
                                    </gal-input>
                                    <span>Key 4</span>
                                </th>
                                <th>
                                    <gal-input input-size="small" no-description>
                                        <input id="key5Filter_SLK5" runat="server" />
                                    </gal-input>
                                    <span>Key 5</span>
                                </th>
                                <th>
                                    <gal-input input-size="small" no-description>
                                        <input id="key6Filter_SLK6" runat="server" />
                                    </gal-input>
                                    <span>Key 6</span>
                                </th>
                            </tr>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <span id="key4_K4" runat="server"></span>
                                </td>
                                <td>
                                    <span id="key5_K5" runat="server"></span>
                                </td>
                                <td>
                                    <span id="key6_K6" runat="server"></span>
