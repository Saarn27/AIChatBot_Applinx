<%@ Page MasterPageFile="~/template.master" Language="C#" CodeFile="T3U01_SFL2_sub_industry.aspx.cs" Inherits="T3U01_SFL2_sub_industry" %>
        ...
        <div class="main-content" id="mainContent">
            ...
            <div style="width: fit-content">
                <div class="table-container">
                    <table id="T3U01_SFL2_sub_industry_1" runat="server" class="table gal6-table-striped">
                        <thead>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <span id="Father_FATHER" runat="server"></span>
