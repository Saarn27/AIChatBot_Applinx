<%@ Page MasterPageFile="~/template.master" Language="C#" CodeFile="T3U01_SFL2_region.aspx.cs" Inherits="T3U01_SFL2_region" %>
    ...
    <div id="gx_screenArea">
        ...
        <div class="main-content" id="mainContent">
            <div class="headline-container">
                <h1 class="headline">REGION</h1>
                <span class="sub-headline separating-line">|</span>
                <h1 class="headline blue-headline">R</h1>
            </div>
            <div style="width: fit-content">
                <div class="table-container">
                    <table id="T3U01_SFL2_region_1" runat="server" class="table gal6-table-striped">
                        <thead>
