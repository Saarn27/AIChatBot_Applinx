...
public partial class T3U01_ADD2_STATECODE : GalLogicWebForm
{
    ...
    protected void page_preFillForm(object sender, EventArgs e)
    {
        ...
        ToggleIndicatorField(new string[] { "LastUpdatedUser_UPDUSR", "UpdateDate_UPDDATE" }, hiddenField);
        DisableComboBox(new HtmlSelect[] { TaxReporting_TR, fre_FRET, SystemCode_IMC });
    }
