<%@ Page MasterPageFile="~/template.master" Language="C#" CodeFile="T3U01_SFL2_division.aspx.cs" Inherits="T3U01_SFL2_division" %>
    ...
    <div id="gx_screenArea">
        ...
        <div class="main-content" id="mainContent">
            <div class="headline-container">
                <h1 class="headline">DIVISION</h1>
                <span class="sub-headline separating-line">|</span>
                <h1 class="headline blue-headline">D</h1>
            </div>
            <div style="width: fit-content">
                <div class="table-container">
                    <table id="T3U01_SFL2_division_1" runat="server" class="table gal6-table-striped">
                        <thead>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td columntype="primaryNumber">
                                    <span id="MDivision_MDIVISION" runat="server"></span>
