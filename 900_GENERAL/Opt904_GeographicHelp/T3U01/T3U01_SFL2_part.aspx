<%@ Page MasterPageFile="~/template.master" Language="C#" CodeFile="T3U01_SFL2_part.aspx.cs" Inherits="T3U01_SFL2_part" %>
    ...
    <div id="gx_screenArea">
        ...
        <div class="main-content" id="mainContent">
            <div class="headline-container">
                <h1 class="headline">PART</h1>
                <span class="sub-headline separating-line">|</span>
                <h1 class="headline blue-headline">P</h1>
            </div>
            <div style="width: fit-content">
                <div class="table-container">
                    <table id="T3U01_SFL2_part_1" runat="server" class="table gal6-table-striped">
                        <thead>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <span id="SIndustry_SINDUSTRY" runat="server"></span>
