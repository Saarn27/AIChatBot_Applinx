<%@ Page MasterPageFile="~/template.master" Inherits="T3U01_SFL2" CodeFile="T3U01_SFL2.aspx.cs" Language="C#" %>
...
<asp:Content ID="data" ContentPlaceHolderID="GXPagePlaceHolder" runat="server">
    <div id="gx_screenArea">
        ...
        <div class="main-content" id="mainContent">
            <div class="headline-container">
                ...
                <h1 class="headline blue-headline" id="subtitle_TYP" runat="server"></h1>
            </div>
            <div style="width: fit-content">
                <div class="table-container">
                    <table id="T3U01_SFL2_1" runat="server" class="table gal6-table-striped">
                        <thead>
    ...
    <script>
        //console.log(document.querySelector("#ctl00_GXPagePlaceHolder_T3U01_SFL2_1").children[0].children[0].children[1])
        let codethValue = document.querySelector("#ctl00_GXPagePlaceHolder_T3U01_SFL2_1").children[0].children[0].children[1]
        let codetdValue = document.querySelector("#ctl00_GXPagePlaceHolder_T3U01_SFL2_1").children[0].children[1].children[1]
        if (codetdValue && !isNaN(codetdValue.innerText)) {
            codetdValue.setAttribute("columntype", "primaryNumber");
            codethValue.setAttribute("columntype", "primaryNumber");
        }
    </script>
</asp:Content>
