<%@ Page MasterPageFile="~/template.master" Language="C#" CodeFile="T3U01_SFL2_country.aspx.cs" Inherits="T3U01_SFL2_country" %>
    ...
    <div id="gx_screenArea">
        ...
        <div class="main-content" id="mainContent">
            <div class="headline-container">
                <h1 class="headline">COUNTRY</h1>
                <span class="sub-headline separating-line">|</span>
                <h1 class="headline blue-headline">C</h1>
            </div>
            <div style="width: fit-content">
                <div class="table-container">
                    <table id="T3U01_SFL2_country_1" runat="server" class="table gal6-table-striped">
                        <thead>
                            <tr class="grid-header">
                                ...
                                <th>
                                    <gal-input input-size="xsmall" no-description>
                                        <input id="col2Src_SEL5" runat="server" />
                                    </gal-input>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <span id="Div_DIV" runat="server"></span>                                    
                                </td>
                                <td>
                                    <span id="CntrCode_COUNTRYCODE" runat="server"></span>
