<%@ Page MasterPageFile="~/template.master" Inherits="T3EU01_C_SFL" CodeFile="T3EU01_C_SFL.aspx.cs" Language="C#" %>
    ...
    <div id="gx_screenArea">
        ...
        <div class="main-content" id="mainContent">
            <div class="headline-container">
                <h1 class="headline">NAICS MAINTENANCE - DELETE CONFIRMATION</h1>
            </div>
            <div style="width: fit-content">
                <div class="table-container">
                    <table id="T3EU01_C_SFL_1" runat="server" class="table gal6-table-striped w-100">
                        <thead>
                    ...
                    <div class="message-container message-container-with-btn">
                        <span class="invalid-feedback" id="C_MSG_msg" style="margin-right: 20px" runat="server"></span>
