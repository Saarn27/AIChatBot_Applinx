<%@ Page MasterPageFile="~/template.master" Inherits="T23U01_SFL1_1" CodeFile="T23U01_SFL1_1.aspx.cs" Language="C#" %>
    ...
    <div id="gx_screenArea">
        ...
        <div class="main-content" id="mainContent">
            ...
            <div class="table-container">
                <table id="T23U01_SFL1_1_1" runat="server" class="table gal6-table-striped">
                    <thead>
                        <tr class="grid-header">
                            ...
                            <th>
                                <gal-input input-size="large" no-description>
                                    <input id="descriptionFilter_SEL3_SHRT" runat="server" />
                                </gal-input>
                            ...
                            <th >
                              <gal-input input-size="small2" no-description>
                                    <input id="parm4Filter_SEL7" runat="server" />
                                </gal-input>
                                <span>%Parm 4</span>
                            ...
                            <th>
                                <gal-input input-size="small2" no-description>
                                    <input id="parm5Filter_SEL8" runat="server" />
                                </gal-input>
                                <span>%Parm 6</span>
                            </th>
                            ...
                            <th>
                                 <gal-input input-size="small2" no-description>
                                    <input id="parm6Filter_SEL9" runat="server" />
                                </gal-input>
                                <span>%Parm 6</span>
                            </th>
                              <th>
                                 <gal-input input-size="small2" no-description>
                                    <input id="parm7Filter_SEL10" runat="server" />
                                </gal-input>
                                <span>%Parm 7</span>
                            </th>
                        </tr>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><span id="descriptionCol_DSL_2" runat="server"></span></td>
                            <td><span id="Parm4Col_PR4" runat="server"></span></td>
                            <td><span id="Parm5Col_PR5" runat="server"></span></td>
                            <td><span id="Parm6Col_PR6" runat="server"></span></td>
                           
                            <td>
                                <span id="Parm7Col_PR7" runat="server"></span>
