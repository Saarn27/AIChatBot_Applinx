...
public partial class CRU03_ADD : GalLogicWebForm
{
    ...
    protected void page_preFillForm(object sender, EventArgs e)
    {
        ...
        FillComboBox(Territory_TERA, AppCache.GetTableData("T3", new string[] { "T" }));
        FillComboBox(Region_RGNA, AppCache.GetTableData("T3", new string[] { "R" }));
        FillComboBox(state_STATA, AppCache.GetTableData("T3", new string[] { "S" }));
