...
public partial class GWTU07_SEL : GalLogicWebForm
{
    ...
    protected void page_preFillForm(object sender, EventArgs e)
    {
        ...
        FillComboBox(type1_ST1, AppCache.GetTableData("T23", new string[] { "G", "SUP", "PRF" }));
        FillComboBox(type2_ST2, AppCache.GetTableData("T23", new string[] { "G", "SUP", "PRF" }));
        FillComboBox(type3_ST3, AppCache.GetTableData("T23", new string[] { "G", "SUP", "PRF" }));
        FillComboBox(type4_ST4, AppCache.GetTableData("T23", new string[] { "G", "SUP", "PRF" }));
        FillComboBox(type5_ST5, AppCache.GetTableData("T23", new string[] { "G", "SUP", "PRF" }));
        FillComboBox(type6_ST6, AppCache.GetTableData("T23", new string[] { "G", "SUP", "PRF" }));

    }
    protected void page_postFillForm(object sender, EventArgs e)
    {
        int fieldRow = 5;
        int startFieldColumn = 25;
        ...
        if (type1_ST1 != null && type1_ST1.Value != null)
        {
            key = type1_ST1.Value.Trim();
        }
        ...
        if (!string.IsNullOrEmpty(key) && codeAndLength.ContainsKey(key))
        {
            ...
            Session["GWT07_SEL_OFFSETSRow1"] = offsets1;
        ...
        if (type2_ST2 != null && type2_ST2.Value != null)
        {
            key2 = type2_ST2.Value.Trim();
        }
        ...
        if (!string.IsNullOrEmpty(key2) && codeAndLength.ContainsKey(key2))
        {
            ...
            Session["GWT07_SEL_OFFSETSRow2"] = offsets2;
        ...
        if (type3_ST3 != null && type3_ST3.Value != null)
        {
            key3 = type3_ST3.Value.Trim();
        }
        ...
        if (!string.IsNullOrEmpty(key3) && codeAndLength.ContainsKey(key3))
        {
            ...
            Session["GWT07_SEL_OFFSETSRow3"] = offsets3;
        ...
        if (type4_ST4 != null && type4_ST4.Value != null)
        {
            key4 = type4_ST4.Value.Trim();
        }
        ...
        if (!string.IsNullOrEmpty(key4) && codeAndLength.ContainsKey(key4))
        {
            ...
            Session["GWT07_SEL_OFFSETSRow4"] = offsets4;
        ...
        if (type5_ST5 != null && type5_ST5.Value != null)
        {
            key5 = type5_ST5.Value.Trim();
        }
        ...
        if (!string.IsNullOrEmpty(key5) && codeAndLength.ContainsKey(key5))
        {
            ...
            Session["GWT07_SEL_OFFSETSRow5"] = offsets5;
        ...
        if (type6_ST6 != null && type6_ST6.Value != null)
        {
            key6 = type6_ST6.Value.Trim();
        }
        ...
        if (!string.IsNullOrEmpty(key6) && codeAndLength.ContainsKey(key6))
        {
            ...
            Session["GWT07_SEL_OFFSETSRow6"] = offsets6;
    ...
    protected void page_preSendKeys(object sender, GXPreSendKeyEventArgs e)
    {
        ...
        string desiredOffset = offsetToPress1.Value;
        string RowNumner = RowNum.Value;
        int fieldRow = 5;
        int startFieldColumn = 25;
        Dictionary<string, string> offsets1 = (Dictionary<string, string>)Session["GWT07_SEL_OFFSETSRow1"];
        Dictionary<string, string> offsets2 = (Dictionary<string, string>)Session["GWT07_SEL_OFFSETSRow2"];
        Dictionary<string, string> offsets3 = (Dictionary<string, string>)Session["GWT07_SEL_OFFSETSRow3"];
        Dictionary<string, string> offsets4 = (Dictionary<string, string>)Session["GWT07_SEL_OFFSETSRow4"];
        Dictionary<string, string> offsets5 = (Dictionary<string, string>)Session["GWT07_SEL_OFFSETSRow5"];
        Dictionary<string, string> offsets6 = (Dictionary<string, string>)Session["GWT07_SEL_OFFSETSRow6"];
