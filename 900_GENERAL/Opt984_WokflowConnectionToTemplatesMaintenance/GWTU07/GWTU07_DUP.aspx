<%@ Page MasterPageFile="~/template.master" Language="C#" CodeFile="GWTU07_DUP.aspx.cs" Inherits="GWTU07_DUP" %>

<%@ Register TagPrefix="gx" Namespace="com.sabratec.dotnet.framework.web.controls" Assembly="GXDotnet" %>
<asp:Content ID="data" ContentPlaceHolderID="GXPagePlaceHolder" runat="server">
    <div class="headline-container modal-header">
        <h1 class="headline">WORKFLOW PROFESSIONALS LIST</h1>
        <span class="sub-headline blue-headline no-color">Duplicate Selections</span>
