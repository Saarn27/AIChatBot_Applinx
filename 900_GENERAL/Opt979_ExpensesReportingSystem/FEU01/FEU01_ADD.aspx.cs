...
public partial class FEU01_ADD : GalLogicWebForm
{
    ...
    protected void page_preFillForm(object sender, EventArgs e)
    {
     ...
     ToggleIndicatorField(new string[] { "SentToUser_AUSRT", "Lastupdatedby_AUPDUSR", "Lastupdatedbydate_AUPDDAT" }, hiddenField, true);
