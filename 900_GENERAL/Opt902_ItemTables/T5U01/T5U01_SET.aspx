<%@ Page MasterPageFile="~/template.master" Language="C#" CodeFile="T5U01_SET.aspx.cs" Inherits="T5U01_SET" %>
    ...
    <div id="gx_screenArea">
        ...
        <div class="main-content" id="mainContent">
            <div class="headline-container">
                <h1 class="headline">Translation Settings For Option</h1>
            ...
            <div class="wrapper-container">
                ...
                <div class="related-fields-area w-100" style="margin-bottom: 15px;">
                    <gal-input label-size="large" label-text="Main system table language:" input-size="small2" no-description>
                        <select id="mainTableLang_SETMAIC" runat="server"></select>
                    </gal-input>
                    <gal-input label-size="large" label-text="Local system table language:" input-size="small2" no-description>
                        <select id="localTableLang_SETLOCC" runat="server"></select>
                    </gal-input>
                </div>

                <div class="related-fields-area w-100">
                        <gal-input label-size="large2" label-text="Company table/local language:" input-size="large">
                            <input id="localLang_LNGLCLC" runat="server" />
                            <input id="localLangDesc_LNGLCLD" runat="server" />
                        </gal-input>
                        <gal-input label-size="large" label-text="System local language:" input-size="large">
                            <input id="systemLocalLang_LNGIMCC" runat="server" />
                            <input id="systemLocalLangDesc_LNGIMCD" runat="server" />
                        </gal-input>
                        <gal-input label-size="large" label-text="Update user/date:" input-size="large,small" no-description>
                ...
                <div class="message-container message-container-with-btn">
                    ...
                    <button type="button" class="btn btn-primary btn-galweb big-button d-flex justify-content-center align-items-center" onclick="gx_SubmitKey('[pf10]');" id="actionBtn">
                        <span id="F10Save" runat="server" class="no-color" style="color: #ffffff"></span>
                    </button>
                </div>
            </div>
