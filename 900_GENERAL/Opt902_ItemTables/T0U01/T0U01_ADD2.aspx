<%@ Page MasterPageFile="~/template.master" Language="C#" CodeFile="T0U01_ADD2.aspx.cs" Inherits="T0U01_ADD2" %>
        ...
        <div class="main-area-form main-area-form-modal" id="mainContent">
            <div style="width: fit-content">
                <div class="related-fields-area">
                    ...
                    <gal-input-help label-size="medium2" label-text="Master family:" input-size="xlarge">
                        <input id="MasterFamily_FAMILY" runat="server" />
                        <input id="MasterFamilyDesc_TEURFM" runat="server" />
                    </gal-input-help>
