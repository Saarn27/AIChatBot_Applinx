<%@ Page MasterPageFile="~/template.master" Inherits="T0U01A_SFL1D" CodeFile="T0U01A_SFL1D.aspx.cs" Language="C#" %>
    ...
    <div id="gx_screenArea">
        ...
        <div class="main-content" id="mainContent">
            ...
            <div class="table-container">
                <table id="T0U01A_SFL1D_1" runat="server" class="table gal6-table-striped no-selection-table">
                    <thead>
                        <tr class="grid-header">
                            <th>
                                <span>Applincation</span>
                            </th>
