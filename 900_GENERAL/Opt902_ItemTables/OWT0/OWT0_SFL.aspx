...
<asp:Content ID="data" ContentPlaceHolderID="GXPagePlaceHolder" runat="server">
    ...
    <div id="gx_screenArea" class="form-grey-BG">
        ...
        <div class="main-area-form main-area-form-modal" id="mainContent">
            <div class="table-container">
                <table id="OWT0_SFL_1" runat="server" class="table gal6-table-striped">
                    <thead>
    ...
    <span id="f11Text" runat="server" style="display:none"></span>
    <script>
        ...
        var f11Text = document.getElementById("ctl00_GXPagePlaceHolder_f11Text");
        var descTh = document.getElementById("descriptionTh");
        if (f11Text.innerText.trim() == 'Short dsc') {
            descTh.innerText = '%Long description';
        }
        else {
            descTh.innerText = '%Short description'
        }
    </script>
</asp:Content>
