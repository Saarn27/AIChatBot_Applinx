...
public partial class XT0HU01_ADD : GalLogicWebForm
{
    ...
    protected void page_preFillForm(object sender, EventArgs e)
    {
        ...
        ToggleIndicatorField(new string[] { "subHeader_KOT1", "crReg1_ACNTRSK", "crReg2_ACNTRS", "crReg3_ACNTRSD" }, hiddenField, true);
    }
