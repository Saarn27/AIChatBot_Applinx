<%@ Page MasterPageFile="~/template.master" Language="C#" CodeFile="T2U03_A_SFL.aspx.cs" Inherits="T2U03_A_SFL" %>
...
<asp:Content ID="data" ContentPlaceHolderID="GXPagePlaceHolder" runat="server">
    <div id="gx_screenArea">
                    ...
                    <div class="spaced-column">
                        <gal-input label-text="Table:" label-size="auto" input-size="small" no-description>
                            <select id="ttype_S_TABLE" runat="server" onchange="gx_SubmitKey('[enter]');">
                                ...
                                <option value="P">Pushing</option>
                            </select>
                        </gal-input>
                    </div>
                </div>
                <gal-table-header text="Shift weeks" start-column="10" end-column="12"></gal-table-header>
                <gal-table-header text="Shipping policy" start-column="13" end-column="14"></gal-table-header>
                <div class="table-container">
                    <table id="T2U03_A_SFL_1" runat="server" class="table gal6-table-striped less-padding-table">
                        <thead>
                            <tr class="grid-header">
                                ...
                                <th sortby="tit3_H_GRP" columntype="primaryNumber">
                                    <gal-input input-size="xsmall" no-description>
                                ...
                                <th sortby="tit7_H_SC" columntype="primaryNumber">
                                ...
                                <th sortby="tit9_H_FORCST" columntype="qty">
                                    <gal-input input-size="xsmall" no-description>
                                        <input id="sel9_S_FORCST" runat="server">
                                    </gal-input>
                                    <span id="tit9_H_FORCST" runat="server"></span>
                                </th>
                                <th sortby="tit10_H_BLANKS" columntype="primaryNumber">
                                    <gal-input input-size="xsmall" no-description>
                                        <input id="sel10_S_BLANKS" runat="server">
                                    </gal-input>
                                    <span id="tit10_H_BLANKS" runat="server"></span>
                                </th>
                                <th sortby="tit11_H_MINB" columntype="primaryNumber">
                                    <gal-input input-size="xsmall" no-description>
                                        <input id="sel11_S_MINB" runat="server">
                                    </gal-input>
                                    <span id="tit11_H_MINB" runat="server"></span>
                                </th>
                                <th sortby="tit12_H_MIN" columntype="primaryNumber">
                                    <gal-input input-size="xsmall" no-description>
                                        <input id="sel12_S_MIN" runat="server">
                                    </gal-input>
                                    <span id="tit12_H_MIN" runat="server"></span>
                                </th>
                                <th sortby="tit13_H_MAX" columntype="primaryNumber">
                                    <gal-input input-size="xsmall" no-description>
                                        <input id="sel13_S_MAX" runat="server">
                                    </gal-input>
        ...
        <div class="legend-div">
            <legend-block text="Offset" color="purple" text-color></legend-block>
        </div>
    </div>
    <script>
