<%@ Page MasterPageFile="~/template.master" Inherits="TSU05_ADDL" CodeFile="TSU05_ADDL.aspx.cs" Language="C#" %>
...
<asp:Content ID="data" ContentPlaceHolderID="GXPagePlaceHolder" runat="server">
    ...
    <div id="gx_screenArea" class="form-grey-BG">
        ...
        <div class="main-area-form main-area-form-modal" style="width: 100%">
            ...
            <div class="related-fields-area">
                <div class="column-form">
                    <gal-input-help label-text="Select rule:" label-size="large" input-size="large2">
                        <input id="selectRule_ASEQ7" runat="server" />
                        <input id="selectRuleDsc_ASEQD" runat="server" />
                    </gal-input-help>
                </div>
            </div>
