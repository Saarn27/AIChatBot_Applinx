<%@ Page MasterPageFile="~/template.master" Inherits="TSU05_ADDC" CodeFile="TSU05_ADDC.aspx.cs" Language="C#" %>
...
<asp:Content ID="data" ContentPlaceHolderID="GXPagePlaceHolder" runat="server">
    ...
    <div id="gx_screenArea" class="form-grey-BG">
        ...
        <div class="main-area-form main-area-form-modal" style="width: 100%">
            ...
            <div class="related-fields-area">
                <div class="column-form">
                    <gal-input-help label-text="Select data type:" label-size="large" input-size="large2">
                        <input id="selectDataType_ASEQ" runat="server" />
                        <input id="dataTypeDesc_ASEQD" runat="server" />
                    </gal-input-help>
                </div>
            </div>
            <div class="sub-headline"></div>
            <div class="related-fields-area">
                <div class="column-form">
                    <gal-input-help label-size="large" input-size="large2" dynamic-label>
                        <input id="title1_SELCTD" runat="server" />
                        <input id="smRgnDivTerCustWhs_AGRP" runat="server" />
                        <input id="grpdesc_AGRPD" runat="server" />
                    </gal-input-help>
                </div>
                <div class="column-form">
                    <gal-input-help label-size="large" input-size="large2" dynamic-label>
                        <input id="title2_SELCTD2" runat="server" />
                        <input id="gebDesc2_AGRP2" runat="server" />
                        <input id="grpDesc_AGRPD2" runat="server" />
                    </gal-input-help>
                </div>
            </div>
            <div class="sub-headline"></div>
            <div class="related-fields-area">
                ...
                <div class="column-form" id="lastDiv" runat="server">
                    <gal-input label-size="large" input-size="small2" dynamic-label no-description>
                        ...
                        <input id="updateusr_AUPDUSR" runat="server" />
                    </gal-input>
                </div>
                <div class="column-form" id="lastDiv2" runat="server">
                    <gal-input label-text="Last updated date:" label-size="large" input-size="small2" no-description>
                        <input id="updateUserDate_AUPDDAT" galtype="date" dateformat="ddmmy" runat="server" />
                    </gal-input>
                </div>
            </div>
