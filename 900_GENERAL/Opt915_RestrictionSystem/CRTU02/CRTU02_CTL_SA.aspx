<%@ Page MasterPageFile="~/template.master" Inherits="CRTU02_CTL_SA" CodeFile="CRTU02_CTL_SA.aspx.cs" Language="C#" %>
    ...
    <div id="gx_screenArea">
        ...
        <div class="main-content" id="mainContent">
            ...
            <div class="table-container">
                <table id="CRTU02_CTL_SA_1" runat="server" class="table gal6-table-striped  less2-padding-table">
                    <thead>
                        <tr class="grid-header">
                            ...
                            <th>
                                <gal-input input-size="large" no-description>
                                    <input id="name_NME_S_SL" runat="server" />
                                </gal-input>
                                <span>%Name</span>
                            </th>
                            <th>
                                <gal-input-help input-size="small" no-description>
                                    <input id="item_CTNUM_SL" runat="server" />
                                </gal-input-help>
                                <span>Item</span>
                            </th>
                            <th>
                                <gal-input input-size="small" no-description>
                                    <select id="salesman_SLSMN_SL" runat="server" />
                                </gal-input>
                                <span>%Salesman</span>
                            </th>
                        </tr>
