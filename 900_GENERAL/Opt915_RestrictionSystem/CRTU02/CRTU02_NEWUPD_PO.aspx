<%@ Page MasterPageFile="~/template.master" Language="C#" CodeFile="CRTU02_NEWUPD_PO.aspx.cs" Inherits="CRTU02_NEWUPD_PO" %>
            ...
            <div class="column-form">
                <div class="spaced-column">
                    <div class="centered-flex">
                        <gal-input label-text="Type:" label-size="small" input-size="xxsmall" no-description>
                            <input id="type_TYPU" runat="server" />
                        </gal-input>
                        <span class="information-icon" data-bs-toggle="tooltip" data-bs-placement="top" title="G/S Type of PO record for statistics"></span>
                    </div>
                    <gal-input-help label-text="Distributor:" label-size="small" input-size="xlarge" no-description>
                        <input id="distributor_DISTU" runat="server" />
                    </gal-input-help>
                </div>
            </div>
            <div class="line"></div>
            <span style="color: #2D7DD2; font-weight: bold; margin-bottom: 10px">Dates Range</span>
            <div class="spaced-column">
                <gal-input label-text="From Date:" label-size="small" input-size="small" no-description>
                    <input id="fromDate_FROM_DTU" runat="server" galtype="date" dateformat="ddmmy" />
                </gal-input>
                <gal-input label-text="To Date:" label-size="small" input-size="small" no-description>
                    <input id="toDate_TO_DTU" runat="server" galtype="date" dateformat="ddmmy" />
                </gal-input>
            </div>
            <div class="centered-flex">
