<%@ Page MasterPageFile="~/template.master" Language="C#" CodeFile="CRTU02_NEWUPD_TR.aspx.cs" Inherits="CRTU02_NEWUPD_TR" %>
        ...
        <div class="main-area-form main-area-form-modal">
            <div class="column-form">
                <div class="spaced-column">
                    <gal-input label-text="Type:" label-size="small" input-size="medium" no-description>
                        <select id="type_TYPEU" runat="server"></select>
                    </gal-input>
                    <gal-input-help label-text="Customer:" label-size="small" input-size="xlarge">
                        <input id="customer_CUSTU" runat="server" />
                        <input id="customerDsc" runat="server" />
                    </gal-input-help>
                    <gal-input-help label-text="End User:" label-size="small" input-size="xlarge">
                        <input id="endUser_ENDUU" runat="server" />
