<%@ Page MasterPageFile="~/template.master" Inherits="CRTU02_CTL_EX_D" CodeFile="CRTU02_CTL_EX_D.aspx.cs" Language="C#" %>
...
<asp:Content ID="data" ContentPlaceHolderID="GXPagePlaceHolder" runat="server">
    <div id="gx_screenArea">
        ...
        <div class="main-content" id="mainContent">
            ...
            <div class="table-container"><table id="CRTU02_CTL_EX_D_1" runat="server" class="table gal6-table-striped">
                <thead>
                ...
                <tbody>
                    <tr>
                        ...
                        <td><span id="name_NME_E" runat="server"></span>
