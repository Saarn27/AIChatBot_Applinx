<%@ Page MasterPageFile="~/template.master" Inherits="CRTU02_CTL_EX" CodeFile="CRTU02_CTL_EX.aspx.cs" Language="C#" %>
    ...
    <div id="gx_screenArea">
        ...
        <div class="main-content" id="mainContent">
            ...
            <div class="table-container">
                <table id="CRTU02_CTL_EX_1" runat="server" class="table gal6-table-striped less2-padding-table">
                    <thead>
                        <tr class="grid-header">
                            ...
                            <th>
                                <gal-input input-size="xxlarge" no-description>
                                    <input id="name_NME_E_SL" runat="server" />
                                </gal-input>
                                <span>%Name</span>
                            </th>
                        </tr>
