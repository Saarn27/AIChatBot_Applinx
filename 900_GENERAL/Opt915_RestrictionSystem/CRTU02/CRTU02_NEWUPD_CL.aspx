<%@ Page MasterPageFile="~/template.master" Language="C#" CodeFile="CRTU02_NEWUPD_CL.aspx.cs" Inherits="CRTU02_NEWUPD_CL" %>
        ...
        <div class="main-area-form main-area-form-modal">
            <div class="column-form">
                <div class="spaced-column">
                    ...
                    <gal-input label-text="Name:" label-size="small" input-size="xlarge" no-description>
                        <input id="name_NAMEUCL" runat="server" />
                    </gal-input>
                    <gal-input label-text="Zip Code:" label-size="small" input-size="medium" no-description>
                        <input id="zipCode_ZIPU" runat="server" />
                    </gal-input>
                    <gal-input-help label-text="End User:" label-size="small" input-size="xlarge">
                        <input id="endUser_CSTUSRU" runat="server" />
                        <input id="endUserDsc" runat="server" />
                    </gal-input-help>
                    <gal-input label-text="Approve:" label-size="small" input-size="xxsmall" no-description>
                        <input id="approve_STSU" runat="server" />
                    </gal-input>
                </div>
            </div>
            <div class="column-form">
                <div class="spaced-column">
                    <gal-input label-text="Approve Date:" label-size="small" input-size="small" no-description>
                        <input galtype="date" dateformat="ddmmyy" id="approveDate_TAPRU" runat="server" />
                    </gal-input>
                ...
                <div class="spaced-column">
                    <gal-input input-size="large">
                        <input id="approveUser_USRUAU" runat="server" />
                        <input id="approveUserDesc_USRUANMEU" runat="server" />
                    </gal-input>
                    <gal-input input-size="large">
