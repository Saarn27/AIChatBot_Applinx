<%@ Page MasterPageFile="~/template.master" Language="C#" CodeFile="CRTU02_NEWUPD_SA.aspx.cs" Inherits="CRTU02_NEWUPD_SA" %>
            ...
            <div class="column-form">
                <div class="spaced-column">
                    <gal-input-help label-text="Distributor:" label-size="small" input-size="xlarge">
                        ...
                        <input id="distributorDesc_DISTNMEU" runat="server" />
                    </gal-input-help>
                    ...
                    <gal-input label-text="Name:" label-size="small" input-size="xxlarge" no-description>
                        <input id="name_NAMEUSA" runat="server" />
                    </gal-input>
                    <gal-input-help label-text="Item Number:" label-size="small" input-size="xlarge">
                        <input id="itemNumber_CATALOGU" runat="server" />
                        <input id="itemNumber_CATALOGNU" runat="server" />
                    </gal-input-help>
                </div>
            </div>
