<%@ Page MasterPageFile="~/template.master" Inherits="CRTU02_CTL_CL1" CodeFile="CRTU02_CTL_CL1.aspx.cs" Language="C#" %>
    ...
    <div id="gx_screenArea">
        ...
        <div class="main-content" id="mainContent">
            ...
            <div class="table-container">
                <table id="CRTU02_CTL_CL1_1" runat="server" class="table gal6-table-striped less2-padding-table">
                    <thead>
                        <tr class="grid-header">
                            ...
                            <th>
                                <gal-input input-size="medium" no-description>
                                    <input id="distName_DIST_SLN" runat="server" />
                                </gal-input>
                                <span>%Distributor Name</span>
                            </th>
                            <th>
                                <gal-input input-size="large" no-description>
                                    <input id="endUserName_NMC_SL1" runat="server" />
                                </gal-input>
