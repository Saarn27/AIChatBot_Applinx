<%@ Page MasterPageFile="~/template.master" Inherits="CRTU02_CTL_IL" CodeFile="CRTU02_CTL_IL.aspx.cs" Language="C#" %>
    ...
    <div id="gx_screenArea">
        ...
        <div class="main-content" id="mainContent">
            ...
            <div class="table-container">
                <table id="CRTU02_CTL_IL_1" runat="server" class="table gal6-table-striped less2-padding-table">
                    <thead>
                        <tr class="grid-header">
                            ...
                            <th>
                                <gal-input-help input-size="medium" no-description>
                                    <input id="itemNumber_CTNUM_SL" runat="server" />
                                </gal-input-help>
                                <span>Item Number</span>
                            </th>
                            <th>
                                <gal-input input-size="large" no-description>
                                    <input id="itemDescription_CTDSC_SL" runat="server" />
                                </gal-input>
                                <span>%Item Description</span>
                            </th>
                            <th>
                                <gal-input input-size="large" no-description>
                                    <input id="posItem_DSCAT_SL" runat="server" />
                                </gal-input>
                                <span>%POS Item</span>
                            </th>
                        </tr>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><span id="itemNumber_CAT" runat="server"></span></td>
                            <td><span id="itemDescription_CAT_DSC" runat="server"></span></td>
                            <td><span id="posItem_DST_CAT" runat="server"></span>
