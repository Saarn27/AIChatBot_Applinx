<%@ Page MasterPageFile="~/template.master" Inherits="CRTU02_CTL_TR" CodeFile="CRTU02_CTL_TR.aspx.cs" Language="C#" %>
    ...
    <div id="gx_screenArea">
        ...
        <div class="main-content" id="mainContent">
            ...
            <div class="table-container">
                <table id="CRTU02_CTL_TR_1" runat="server" class="table gal6-table-striped less2-padding-table">
                    <thead>
                        <tr class="grid-header">
                            ...
                            <th>
                                <gal-input-help input-size="small" no-description>
                                    <input id="type_TR_TYP_S" runat="server" />
                                </gal-input-help>
                                <span>%Type</span>
                            </th>
                            <th>
                                <gal-input-help input-size="medium" no-description>
                                    <input id="customer_TR_CS_SL" runat="server" />
                                </gal-input-help>
                                <span>Customer</span>
                            </th>
                            <th>
                                <gal-input-help input-size="xlarge" no-description>
                                    <input id="customerName_TR_CNM_S" runat="server" />
                                </gal-input-help>
                                <span>%Customer Name</span>
                            </th>
                            <th>
                                <gal-input-help input-size="small" no-description>
                                    <input id="endUser_TR_EU_SL" runat="server" />
                                </gal-input-help>
                                <span>End User</span>
                            </th>
                        </tr>
