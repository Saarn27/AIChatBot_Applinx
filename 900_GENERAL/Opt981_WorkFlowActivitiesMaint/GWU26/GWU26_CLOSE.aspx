<%@ Page MasterPageFile="~/template.master" Inherits="GWU26_CLOSE" CodeFile="GWU26_CLOSE.aspx.cs" Language="C#" %>
<%@ Register TagPrefix="gx" Namespace="com.sabratec.dotnet.framework.web.controls" Assembly="GXDotnet" %>
<asp:Content ID="data" ContentPlaceHolderID="GXPagePlaceHolder" runat="server">
    <div class="headline-container modal-header">
        <h1 class="headline" id="Headline" runat="server">CLOSE CONFIRMATION</h1>
    ...
    <div id="gx_screenArea" class="form-grey-BG">
        <div class="main-area-form main-area-form-modal">
            <%--<gal-input label-text=" " input-size="xxlarge" no-description>
                <label>Are you sure that you want to close?</label>
            </gal-input>--%>
            <div class="column-form">
                <div class="spaced-column">
                    <div>
                        <span>Are you sure that you want to close?</span>
                    </div>
                </div>
            </div>
        </div>
