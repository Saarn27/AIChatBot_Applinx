...
public partial class GWU26_SFL11 : GalLogicWebForm
{
    ...
    protected void page_preFillForm(object sender, EventArgs e)
    {
        ...
        FillComboBox(filterCustType_SLCUSTT, AppCache.GetTableData("T23", new string[] { "X", "SYS", "CVT" }));
        ToggleIndicatorField(new string[] { "orderSign" }, hiddenField, true, false);
        AppendIconKeyToToolbar(hostKeysToolbar, "", "default");
        ToggleIndicatorField(new string[] { "partImcIN_SIMC" }, hiddenField, true, false);
