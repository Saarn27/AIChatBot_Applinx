...
public partial class GXKU01_MOVE_LIN : GalLogicWebForm
{
    ...
    protected void page_preFillForm(object sender, EventArgs e)
    {
        ...
        FillComboBox(PrinterType_PRT_TYP, AppCache.GetTableData("T23", new string[] { "G", "GEN", "BAR" }));

        DisableComboBox(new HtmlSelect[] { PrinterType_PRT_TYP });
    }
