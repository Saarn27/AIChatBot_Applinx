...
public partial class GXKU01_SLT : GalLogicWebForm
{
    ...
    protected void page_preFillForm(object sender, EventArgs e)
    {
        ...
        ToggleIndicatorField(new string[] { "ProductionOrder_PROD", "CustomerNumber_CUST", "User_USER", "Job_JOB", "ProPrinteroutput_GXK2OUTQ" }, hiddenField, true);
    }
