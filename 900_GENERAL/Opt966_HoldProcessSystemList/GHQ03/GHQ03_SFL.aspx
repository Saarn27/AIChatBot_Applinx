<%@ Page MasterPageFile="~/template.master" Inherits="GHQ03_SFL" CodeFile="GHQ03_SFL.aspx.cs" Language="C#" %>
    ...
    <div id="gx_screenArea">
        ...
        <div class="main-content" id="mainContent">
            ...
            <div class="table-container">
                ...
                <table id="GHQ03_TABLE_SFL" runat="server" class="table gal6-table-striped">
                    <thead>
                        <tr class="grid-header">
                            ...
                            <th columntype="primaryNumber" style="width: 100px;">
                                <gal-input input-size="small" no-description>
                            ...
                            <th columntype="qty">
                                <gal-input input-size="xsmall" no-description>
                                    <input id="day_TOPN" runat="server" />
                                </gal-input>
                                <span>Day</span>
                            </th>
                        </tr>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><span id="descriptionCol_DESC" runat="server"></span></td>
                            <td><span id="userCol_USR" runat="server"></span></td>
                            <td columntype="qty"><span id="dayCol_TOPN" runat="server"></span>
